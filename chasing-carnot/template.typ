...
// Chinese: Noto Serif CJK SC is available in Ubuntu's fonts-noto-cjk package,
// which keeps standalone GitHub Actions builds reproducible. Songti SC / STSong
// cover macOS local builds. Charter covers Latin glyphs inside CJK strings via
// Typst's covers spec.
#let body-font-zh = (
...
// macOS-bundled Menlo. CJK serif tail keeps code comments / SVG labels
// glyph-safe.
#let code-font = (
    "JetBrains Mono",
    "Fira Code",
